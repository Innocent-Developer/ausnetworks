  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      if (
        ...
        "Transfer completed successfully and notifications sent"
      ) {
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center p-5">
        <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md md:max-w-2xl lg-max-w-4xl">
          ...
          <h3 className="text-4xl font-semibold text-gray-800 text-center my-2">
            {formatBalance(Math.round(totalBalance))}{" "}
            <strong className="text-green-600">AUSC</strong>
          </h3>
                ...
                <form className="mt-4 space-y-3" onSubmit={handleSend}>
                  ...
                  <div className="flex justify-end space-x-2">
                    <button
                      type="button"
                      onClick={() =>
                        setAmount((totalBalance * 0.25 * 0.9).toFixed(2))
                      }
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setAmount((totalBalance * 0.5 * 0.9).toFixed(2))
                      }
                      className="bg-blue-600 text-white py-2 px-4 rounded-full shadow-lg hover:bg-blue-700 transition duration-300"
                    >
                      50%
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setAmount((totalBalance * 0.75 * 0.9).toFixed(2))
                      }
                      className="bg-blue-600 text-white py-2 px-4 rounded-full shadow-lg hover:bg-blue-700 transition duration-300"
                    >
                      75%
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <div className="mt-4 flex justify-center">
                  <QRCodeCanvas value={receiverAddress} />{" "}
                  {/* Display QR code */}
                </div>

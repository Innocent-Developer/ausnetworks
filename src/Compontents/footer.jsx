      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">A-U-S Networks</h3>
            <p className="text-gray-400">Empowering the future of decentralized networks through innovative blockchain solutions.</p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/mining" className="text-gray-400 hover:text-white transition-colors duration-200">Mining</a></li>
              <li><a href="/wallet" className="text-gray-400 hover:text-white transition-colors duration-200">Wallet</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Whitepaper</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} A-U-S Networks. All rights reserved.
            </p>
